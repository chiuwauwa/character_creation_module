"""Создаем персонажа для ролевой игры.
Включен модуль run_screensaver от Тимура
"""
...
def special(char_name: str, char_class: str) -> str:
    """Специальное умение персонажа от его типа"""
    if char_class == 'warrior':
        return (
